...
{{- define "ndb.backupsidecarcontainerfullname" -}}
{{- $prefix := default "" .Values.global.k8sResource.container.prefix | lower -}}
{{- $imagename := default "db-backup-executor" .Values.sidecar.image.name | lower -}}
...
*/}}
{{- define "ndb.labels" -}}
helm.sh/chart: {{ include "ndb.chart" . }}
{{ include "ndb.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "ndb.serviceAccountName" -}}
  {{- if .Values.serviceAccount.create -}}
    {{ default (include "ndb.fullname" .) .Values.serviceAccount.name }}
  {{- else -}}
